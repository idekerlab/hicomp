...
def main(args):
    ...
    :return: return value of :py:meth:`hicomp.runner.HicompRunner.run`
    ...
    Invokes run() method on HicompRunner

    """.format(version=hicomp.__version__)
    theargs = _parse_arguments(desc, args[1:])
    theargs.program = args[0]
    theargs.version = hicomp.__version__
