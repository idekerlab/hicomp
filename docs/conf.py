...
# -*- coding: utf-8 -*-
#
# hicomp documentation build configuration file, created by
...
project = u'Hierarchy Comparison'
...
init_file = os.path.join('..', 'hicomp', '__init__.py')
...
latex_documents = [
    (master_doc, 'hicomp.tex',
     u'Hierarchy Comparison Documentation',
     u'Gege Qian', 'manual'),
]
